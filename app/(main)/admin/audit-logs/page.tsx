...
import type { AuditLogsData } from '@/lib/contracts/pages';
...
const AdminAuditLogsPage = async ({ searchParams }: Props) => {
  const { action, status, logs, users } = await fetchServerApi<AuditLogsData>('/admin/audit-logs', await searchParams);
